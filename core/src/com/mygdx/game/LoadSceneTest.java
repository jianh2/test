...
//        assets.load("data/spacesphere.obj", Model.class);
    ...
    private void doneLoading() {
        ship = new ModelInstance(assets.get("data/Bot.obj", Model.class));
        ...
        Model invaderModel = assets.get("data/Paladin.obj", Model.class);
        for (float x = -500f; x <= 500f; x += 200f) {
            for (float z = -800f; z <= 0f; z += 200f) {
